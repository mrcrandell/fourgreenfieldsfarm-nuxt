...
async function submitForm() {
  ...
  try {
    ...
    formData.value.endsAt = `${formData.value.startDate}T${
      !formData.value.isHasEndsAt ? "23:59" : formData.value.endTime
    }`;
...
function handleEndDateChange(e) {
  if (e.target.checked) {
    ...
    formData.value.recurringEndDate = formData.value.startsAt.split("T")[0];
  } else {
...
function generateRecurrenceRule() {
  ...
  if (formData.value.recurringCount !== null) {
      ...
      >
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            ...
            <div v-if="formData.recurringCount !== null" class="ms-4 mt-2">
              <input
          ...
          <div class="form-check">
            <input
              ...
              class="form-check-input"
              name="end-recurrence"
              :checked="formData.recurringEndDate !== null"
              @change="handleEndDateChange"
            />
            <label class="form-check-label" for="end-on-date">On date</label>
            <div v-if="formData.recurringEndDate !== null" class="ms-4 mt-2">
              <input
